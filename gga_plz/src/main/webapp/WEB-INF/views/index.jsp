...
<script src="http://localhost:9000/gga_plz/js/weather_api.js"></script>
	...
	<div class="container text-center">
		<div class="section1">
			...
			<div class="ggamovietitle">
			    <img src="http://localhost:9000/gga_plz/images/ggamovietitle.png">
			    </div>
		...
		<div class="section2">
		 		<div class="nowtitle">
			    <img src="http://localhost:9000/gga_plz/images/nowtitle.png">
			    </div>
		 	<div class="row row-cols-1 row-cols-md-5 mb-5 justify-content-center">
		 		<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
				        	<img src="http://localhost:9000/gga_plz/images/darknight.jpg" 
		    	...
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_plz/images/dune.jpg" 
		    	...
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_plz/images/inception.jpg" 
		    	...
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_plz/images/slamdunk.jpg" 
		    	...
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_plz/images/door.jpg" 
			  ...
			  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
				  <div class="carousel-inner">
				    <div class="carousel-item active">
				      <img src="http://localhost:9000/gga_plz/images/bannerimg2.jpg" class="d-block w-100" style="height: 200px;" alt="...">
				    </div>
				  <div class="carousel-item">
				      <img src="http://localhost:9000/gga_plz/images/bannerimg3.jpg" class="d-block w-100" style="height: 200px;" alt="...">
				  </div>
				    <div class="carousel-item">
				      <img src="http://localhost:9000/gga_plz/images/footerimg2.jpg" class="d-block w-100" style="height: 200px;" alt="...">
				    </div>
				  </div>
		...
		<div class="section4">
			<div class="row">
			    <div class="mapimg">
			    <img src="http://localhost:9000/gga_plz/images/map.png">
			    </div>
			</div>
			<div class="row">
				<div class="col-9">
