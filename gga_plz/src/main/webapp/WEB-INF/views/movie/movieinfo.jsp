...
<body>
	...
	<div class="container">
		<div class="content">
				...
				<div class="row">
					...
					<div class="col">
						<table>
							...
							<tr>
								<th><img src="http://localhost:9000/gga_plz/images/descdate.png"></th>
								<td>${movieVo.moviedday}</td>
							</tr>
							<tr>
								<th><img src="http://localhost:9000/gga_plz/images/descdirector.png"></th>
								<td>${movieVo.director}</td>
							</tr>
							<tr>
								<th><img src="http://localhost:9000/gga_plz/images/descactor.png"></th>
								<td>${movieVo.actor}</td>
							</tr>
							<tr>
								<th><img src="http://localhost:9000/gga_plz/images/descgenre.png"></th>
								<td>${movieVo.genre}</td>
							</tr>
							<tr>
								<th><img src="http://localhost:9000/gga_plz/images/descrun.png"></th>
								<td>${movieVo.runtime}</td>
							</tr>
							<tr>
								<th><img src="http://localhost:9000/gga_plz/images/descgrade.png"></th>
								<td>94% 만족</td>
							</tr>
						</table>
					</div>
			...
			<div class="still_cut">
				<img src="http://localhost:9000/gga_plz/images/stillcut.jpg" >
			</div>
