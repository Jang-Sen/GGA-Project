...
<script>
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "http://localhost:9000/gga_plz/movie_list.do?page="+e.page);         
	    });
	...
	<div class="movie_manager_title">
		...
		<section class="moviemanager">
			<table class="table" style="width: 90%;">
				<tr>
					<td colspan="7">
						<a class="addmoviebtn" href="http://localhost:9000/gga_plz/movie_register.do">
						<button type="button"><img src="http://localhost:9000/gga_plz/images/addmoviebtn.png"></button></a>
						<br><br>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><a href="movie_content.do?movieid=${movieVo.movieid}">${movieVo.movietitle}</a></td>
					<td>${movieVo.genre}</td>
