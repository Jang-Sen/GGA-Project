...
<script src="http://localhost:9000/gga_plz/js/am-pagination.js"></script> <!-- am-pagination.js -->
...
<script>
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "http://localhost:9000/gga_plz/admin_member_list.do?page="+e.page);         
	    });
...
<body>
	...
	<div class="container text-center">
		...
		<img src="http://localhost:9000/gga_plz/images/adminmembertitle.png">
		</div>
