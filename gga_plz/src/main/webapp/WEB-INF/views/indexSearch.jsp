...
<!-- header -->
	...
	<!-- <div class="noneResult">
		<img src="http://localhost:9000/gga_plz/images/indexSearchNoneResult.png">
		...
		<!-- <div class="movieSearch">
			...
			<div class="movieSearchResult">
				<div class="movieSearchInfo">
					<a href="#"><img src="http://localhost:9000/gga_plz/images/knife.jpg" class="movieSearchInfoImg" id="MOVIE_0006"></a>
		...
		<div class="boardSearch">
			<div class="boardSearchResult">
				<div class="boardSearchTitle">
					<img src="http://localhost:9000/gga_plz/images/boardtitle.png">
					<p>*조회수 정렬</p>
				</div>
				<table>
					<tr>
		...
		<div class="movieSearch">
			...
			<div class="movieSearchResult">
				<div class="movieSearchInfo" id="storeSearchInfo">
					<a href="#"><img src="http://localhost:9000/gga_plz/images/popcorn.png" class="movieSearchInfoImg" id="MOVIE_0006"></a>
