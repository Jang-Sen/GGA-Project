	...
	<div class="container">
		...
		<div class="container text-center">
			<section class="login">
				<ul>
					<li>
						<a href= "http://localhost:9000/gga_plz/join.do">
							<img src="http://localhost:9000/gga_plz/images/joinbtn.png" class="loginbtnbtn"></a>
						<a href= "http://localhost:9000/gga_plz/login.do">
							<img src="http://localhost:9000/gga_plz/images/loginbtn.png" class="loginbtnbtn">
						</a>
					</li>
					<li>
